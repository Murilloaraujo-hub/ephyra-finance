      ...
      <div class="onboarding-card anim-scale">
        ...
        <div class="onboarding-image-side">
          <div class="onboarding-image-container">
            ...
            <img class="onboarding-real-image" src="${imagePath}" alt="${step.title}" onload="this.nextElementSibling.style.display='none';" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
